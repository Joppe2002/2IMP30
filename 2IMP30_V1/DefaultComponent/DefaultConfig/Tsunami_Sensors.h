...
//#[ ignore
#define OMAnim_SystemContext_Tsunami_Sensors_setRaw_vibration_location_int_ARGS_DECLARATION int p_raw_vibration_location;
...
//#[ ignore
    //## package SystemContext
    class p_Tsunami_Sensors_C : public int_raw_vibrations_ProxyFlowPropertyInterface, public int_raw_vibration_location_ProxyFlowPropertyInterface {
...
#ifdef _OMINSTRUMENT
DECLARE_OPERATION_CLASS(SystemContext_Tsunami_Sensors_setRaw_vibration_location_int)
...
class OMAnimatedTsunami_Sensors : virtual public AOMInstance {
    ...
    DECLARE_META_OP(SystemContext_Tsunami_Sensors_setRaw_vibration_location_int)
