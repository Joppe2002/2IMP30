...
//#]
    ...
    //## auto_generated
    const bool getBehavior_hail(void) const;
    
    //## auto_generated
    void setBehavior_hail(const bool p_behavior_hail);
    
    //## auto_generated
    const bool getBehavior_rain(void) const;
    
    //## auto_generated
    void setBehavior_rain(const bool p_behavior_rain);
    
    //## auto_generated
    const bool getBehavior_snow(void) const;
    
    //## auto_generated
    void setBehavior_snow(const bool p_behavior_snow);
...
private :
    ...
    bool behavior_hail;		//## attribute behavior_hail
    
    bool behavior_rain;		//## attribute behavior_rain
    
    bool behavior_snow;		//## attribute behavior_snow
...
public :
    ...
    // relaying_sensor_data:
    //## statechart_method
    inline RhpBoolean relaying_sensor_data_IN(void) const;
    
    // polling_sensor_data:
    //## statechart_method
    inline RhpBoolean polling_sensor_data_IN(void) const;
...
//#[ ignore
    enum Data_Storage_Enum {
        OMNonState = 0,
        MainBehavior = 1,
        relaying_sensor_data = 2,
        polling_sensor_data = 3,
        idle = 4,
        accepttimeevent_3 = 5,
        accepttimeevent_2 = 6,
        ErrorHandling = 7,
...
public :
    ...
    //## statechart_method
    void relaying_sensor_data_serializeStates(AOMSState* aomsState) const;
    
    //## statechart_method
    void polling_sensor_data_serializeStates(AOMSState* aomsState) const;
...
inline RhpBoolean Data_Storage::relaying_sensor_data_IN(void) const {
    return MainBehavior_subState == relaying_sensor_data;
}

inline RhpBoolean Data_Storage::polling_sensor_data_IN(void) const {
    return MainBehavior_subState == polling_sensor_data;
}
