...
void Architecture_OMConnectRelations(void) {
    ...
    itsActionable_Information_Generator.setItsTsunami_Prediction(&itsTsunami_Prediction);
    {
        ...
        itsSMSWTD.get_p_SMSWTD()->setItsInt_warning_type_ProxyFlowPropertyInterface(itsMobile_Apps.get_p_Mobile_Apps()->getItsInt_warning_type_ProxyFlowPropertyInterface());
        
    }
    {
        
        itsSMSWTD.get_p_SMSWTD()->setItsInt_warning_type_ProxyFlowPropertyInterface(itsNews_Outlets.get_p_News_Outlets()->getItsInt_warning_type_ProxyFlowPropertyInterface());
        
    }
    {
        
        itsSMSWTD.get_p_SMSWTD()->setItsInt_warning_type_ProxyFlowPropertyInterface(itsSMS_Signaling.get_p_SMS_Signaling()->getItsInt_warning_type_ProxyFlowPropertyInterface());
        
    }
    {
        
        itsSMSWTD.get_p_SMSWTD_3()->setItsBool_pred_direction_ProxyFlowPropertyInterface(itsGovernment_Networks.get_p_Government_Networks_1()->getItsBool_pred_direction_ProxyFlowPropertyInterface());
        
        itsSMSWTD.get_p_SMSWTD_3()->setItsFloat_pred_severity_ProxyFlowPropertyInterface(itsGovernment_Networks.get_p_Government_Networks_1()->getItsFloat_pred_severity_ProxyFlowPropertyInterface());
        
        itsSMSWTD.get_p_SMSWTD_3()->setItsFloat_pred_probability_ProxyFlowPropertyInterface(itsGovernment_Networks.get_p_Government_Networks_1()->getItsFloat_pred_probability_ProxyFlowPropertyInterface());
        
        itsSMSWTD.get_p_SMSWTD_3()->setItsFloat_pred_speed_ProxyFlowPropertyInterface(itsGovernment_Networks.get_p_Government_Networks_1()->getItsFloat_pred_speed_ProxyFlowPropertyInterface());
        
        itsSMSWTD.get_p_SMSWTD_3()->setItsFloat_storm_probability_ProxyFlowPropertyInterface(itsGovernment_Networks.get_p_Government_Networks_1()->getItsFloat_storm_probability_ProxyFlowPropertyInterface());
        
    }
    {
        
        itsSMSWTD.get_p_SMSWTD_3()->setItsBool_pred_direction_ProxyFlowPropertyInterface(itsNews_Outlets.get_p_News_Outlets_1()->getItsBool_pred_direction_ProxyFlowPropertyInterface());
        
        itsSMSWTD.get_p_SMSWTD_3()->setItsFloat_pred_severity_ProxyFlowPropertyInterface(itsNews_Outlets.get_p_News_Outlets_1()->getItsFloat_pred_severity_ProxyFlowPropertyInterface());
        
        itsSMSWTD.get_p_SMSWTD_3()->setItsFloat_pred_probability_ProxyFlowPropertyInterface(itsNews_Outlets.get_p_News_Outlets_1()->getItsFloat_pred_probability_ProxyFlowPropertyInterface());
        
        itsSMSWTD.get_p_SMSWTD_3()->setItsFloat_pred_speed_ProxyFlowPropertyInterface(itsNews_Outlets.get_p_News_Outlets_1()->getItsFloat_pred_speed_ProxyFlowPropertyInterface());
        
        itsSMSWTD.get_p_SMSWTD_3()->setItsFloat_storm_probability_ProxyFlowPropertyInterface(itsNews_Outlets.get_p_News_Outlets_1()->getItsFloat_storm_probability_ProxyFlowPropertyInterface());
    ...
    }
    {
        ...
        itsActionable_Information_Generator.get_p_Actionable_Information_Generator()->setItsInt_warning_type_ProxyFlowPropertyInterface(itsSMSWTD.get_p_SMSWTD_1()->getItsInt_warning_type_ProxyFlowPropertyInterface());
        
    }
    {
        
        itsStorm_Prediction.get_p_Storm_Prediction()->setItsBool_pred_direction_ProxyFlowPropertyInterface(itsSMSWTD.get_p_SMSWTD_2()->getItsBool_pred_direction_ProxyFlowPropertyInterface());
        
        itsStorm_Prediction.get_p_Storm_Prediction()->setItsFloat_pred_severity_ProxyFlowPropertyInterface(itsSMSWTD.get_p_SMSWTD_2()->getItsFloat_pred_severity_ProxyFlowPropertyInterface());
        
        itsStorm_Prediction.get_p_Storm_Prediction()->setItsFloat_pred_probability_ProxyFlowPropertyInterface(itsSMSWTD.get_p_SMSWTD_2()->getItsFloat_pred_probability_ProxyFlowPropertyInterface());
        
        itsStorm_Prediction.get_p_Storm_Prediction()->setItsFloat_pred_speed_ProxyFlowPropertyInterface(itsSMSWTD.get_p_SMSWTD_2()->getItsFloat_pred_speed_ProxyFlowPropertyInterface());
        
        itsStorm_Prediction.get_p_Storm_Prediction()->setItsFloat_storm_probability_ProxyFlowPropertyInterface(itsSMSWTD.get_p_SMSWTD_2()->getItsFloat_storm_probability_ProxyFlowPropertyInterface());
