...
const bool Storm_Prediction::getEmergencyResponders_info(void) const {
    return emergencyResponders_info;
}

void Storm_Prediction::setEmergencyResponders_info(const bool p_emergencyResponders_info) {
...
void Storm_Prediction::state_6_entDef(void) {
    ...
    state_6_active = idle;
    state_6_timeout = scheduleTimeout(4000, "ROOT.normal_operation.state_6.idle");
