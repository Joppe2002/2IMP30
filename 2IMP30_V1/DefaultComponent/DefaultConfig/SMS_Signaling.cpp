...
//## class SMS_Signaling
//#[ ignore
SMS_Signaling::p_Warning_Input_C::p_Warning_Input_C(void) : int_warning_type_ProxyFlowPropertyInterface(), _p_(0), itsInt_warning_type_ProxyFlowPropertyInterface(NULL) {
}

SMS_Signaling::p_Warning_Input_C::~p_Warning_Input_C(void) {
    cleanUpRelations();
}

void SMS_Signaling::p_Warning_Input_C::connectSMS_Signaling(SMS_Signaling* part) {
    setItsInt_warning_type_ProxyFlowPropertyInterface(part);
    
}

int_warning_type_ProxyFlowPropertyInterface* SMS_Signaling::p_Warning_Input_C::getItsInt_warning_type_ProxyFlowPropertyInterface(void) {
    return this;
}

void SMS_Signaling::p_Warning_Input_C::setWarning_type(int p_warning_type) {
...
void SMS_Signaling::p_Warning_Input_C::setItsInt_warning_type_ProxyFlowPropertyInterface(int_warning_type_ProxyFlowPropertyInterface* const p_int_warning_type_ProxyFlowPropertyInterface) {
    itsInt_warning_type_ProxyFlowPropertyInterface = p_int_warning_type_ProxyFlowPropertyInterface;
}

void SMS_Signaling::p_Warning_Input_C::cleanUpRelations(void) {
    if(itsInt_warning_type_ProxyFlowPropertyInterface != NULL)
        {
...
SMS_Signaling::p_Warning_Input_C* SMS_Signaling::getP_Warning_Input(void) const {
    return (SMS_Signaling::p_Warning_Input_C*) &p_Warning_Input;
}

SMS_Signaling::p_Warning_Input_C* SMS_Signaling::get_p_Warning_Input(void) const {
    return (SMS_Signaling::p_Warning_Input_C*) &p_Warning_Input;
}
...
void SMS_Signaling::OMConnectRelations(void) {
    if (get_p_Warning_Input() != NULL) {
        get_p_Warning_Input()->connectSMS_Signaling(this);
    }
}
