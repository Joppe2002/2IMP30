...
#define Architecture_Data_Storage_update_GUI_SERIALIZE OM_NO_OP
//#]
...
bool_raw_wind_direction_ProxyFlowPropertyInterface* Data_Storage::p_Storm_Input_C::getItsBool_raw_wind_direction_ProxyFlowPropertyInterface(void) {
    return this;
}

int_raw_precipitation_amount_ProxyFlowPropertyInterface* Data_Storage::p_Storm_Input_C::getItsInt_raw_precipitation_amount_ProxyFlowPropertyInterface(void) {
    return this;
}

int_raw_precipitation_type_ProxyFlowPropertyInterface* Data_Storage::p_Storm_Input_C::getItsInt_raw_precipitation_type_ProxyFlowPropertyInterface(void) {
    return this;
}

int_raw_wind_speed_ProxyFlowPropertyInterface* Data_Storage::p_Storm_Input_C::getItsInt_raw_wind_speed_ProxyFlowPropertyInterface(void) {
    return this;
}

void Data_Storage::p_Storm_Input_C::setRaw_precipitation_amount(int p_raw_precipitation_amount) {
...
void Data_Storage::p_Storm_Input_C::setRaw_precipitation_type(int p_raw_precipitation_type) {
...
void Data_Storage::p_Storm_Input_C::setRaw_wind_direction(bool p_raw_wind_direction) {
...
void Data_Storage::p_Storm_Input_C::setRaw_wind_speed(int p_raw_wind_speed) {
...
void Data_Storage::p_Storm_Input_C::setItsBool_raw_wind_direction_ProxyFlowPropertyInterface(bool_raw_wind_direction_ProxyFlowPropertyInterface* const p_bool_raw_wind_direction_ProxyFlowPropertyInterface) {
    itsBool_raw_wind_direction_ProxyFlowPropertyInterface = p_bool_raw_wind_direction_ProxyFlowPropertyInterface;
}

void Data_Storage::p_Storm_Input_C::setItsInt_raw_precipitation_amount_ProxyFlowPropertyInterface(int_raw_precipitation_amount_ProxyFlowPropertyInterface* const p_int_raw_precipitation_amount_ProxyFlowPropertyInterface) {
    itsInt_raw_precipitation_amount_ProxyFlowPropertyInterface = p_int_raw_precipitation_amount_ProxyFlowPropertyInterface;
}

void Data_Storage::p_Storm_Input_C::setItsInt_raw_precipitation_type_ProxyFlowPropertyInterface(int_raw_precipitation_type_ProxyFlowPropertyInterface* const p_int_raw_precipitation_type_ProxyFlowPropertyInterface) {
    itsInt_raw_precipitation_type_ProxyFlowPropertyInterface = p_int_raw_precipitation_type_ProxyFlowPropertyInterface;
}

void Data_Storage::p_Storm_Input_C::setItsInt_raw_wind_speed_ProxyFlowPropertyInterface(int_raw_wind_speed_ProxyFlowPropertyInterface* const p_int_raw_wind_speed_ProxyFlowPropertyInterface) {
    itsInt_raw_wind_speed_ProxyFlowPropertyInterface = p_int_raw_wind_speed_ProxyFlowPropertyInterface;
}

void Data_Storage::p_Storm_Input_C::cleanUpRelations(void) {
    if(itsBool_raw_wind_direction_ProxyFlowPropertyInterface != NULL)
        {
...
Data_Storage::p_Tsunami_Input_C::p_Tsunami_Input_C(void) : int_raw_vibrations_distance_ProxyFlowPropertyInterface(), int_raw_vibrations_intensity_ProxyFlowPropertyInterface(), _p_(0), itsInt_raw_vibrations_distance_ProxyFlowPropertyInterface(NULL), itsInt_raw_vibrations_intensity_ProxyFlowPropertyInterface(NULL) {
}

Data_Storage::p_Tsunami_Input_C::~p_Tsunami_Input_C(void) {
    cleanUpRelations();
}

void Data_Storage::p_Tsunami_Input_C::connectData_Storage(Data_Storage* part) {
...
int_raw_vibrations_distance_ProxyFlowPropertyInterface* Data_Storage::p_Tsunami_Input_C::getItsInt_raw_vibrations_distance_ProxyFlowPropertyInterface(void) {
    return this;
}

int_raw_vibrations_intensity_ProxyFlowPropertyInterface* Data_Storage::p_Tsunami_Input_C::getItsInt_raw_vibrations_intensity_ProxyFlowPropertyInterface(void) {
    return this;
}

void Data_Storage::p_Tsunami_Input_C::setRaw_vibrations_distance(int p_raw_vibrations_distance) {
...
void Data_Storage::p_Tsunami_Input_C::setRaw_vibrations_intensity(int p_raw_vibrations_intensity) {
...
void Data_Storage::p_Tsunami_Input_C::setItsInt_raw_vibrations_distance_ProxyFlowPropertyInterface(int_raw_vibrations_distance_ProxyFlowPropertyInterface* const p_int_raw_vibrations_distance_ProxyFlowPropertyInterface) {
    itsInt_raw_vibrations_distance_ProxyFlowPropertyInterface = p_int_raw_vibrations_distance_ProxyFlowPropertyInterface;
}

void Data_Storage::p_Tsunami_Input_C::setItsInt_raw_vibrations_intensity_ProxyFlowPropertyInterface(int_raw_vibrations_intensity_ProxyFlowPropertyInterface* const p_int_raw_vibrations_intensity_ProxyFlowPropertyInterface) {
    itsInt_raw_vibrations_intensity_ProxyFlowPropertyInterface = p_int_raw_vibrations_intensity_ProxyFlowPropertyInterface;
}

void Data_Storage::p_Tsunami_Input_C::cleanUpRelations(void) {
    if(itsInt_raw_vibrations_distance_ProxyFlowPropertyInterface != NULL)
        {
...
void Data_Storage::update_GUI(void) {
    NOTIFY_OPERATION(update_GUI, update_GUI(), 0, Architecture_Data_Storage_update_GUI_SERIALIZE);
    //#[ operation update_GUI()
    if(raw_precipitation_type == 0){
    behavior_rain = false;
    behavior_snow = false;
    behavior_hail = false;}
    if(raw_precipitation_type == 1){
    behavior_rain = true;
    behavior_snow = false;
    behavior_hail = false;}
    if(raw_precipitation_type == 2){
    behavior_rain = false;
    behavior_snow = false;
    behavior_hail = true;}
    if(raw_precipitation_type == 3){
    behavior_rain = false;
    behavior_snow = true;
    behavior_hail = false;}
...
Data_Storage::p_Storm_Input_C* Data_Storage::getP_Storm_Input(void) const {
    return (Data_Storage::p_Storm_Input_C*) &p_Storm_Input;
}

Data_Storage::p_Storm_Input_C* Data_Storage::get_p_Storm_Input(void) const {
    return (Data_Storage::p_Storm_Input_C*) &p_Storm_Input;
}

Data_Storage::p_Tsunami_Input_C* Data_Storage::getP_Tsunami_Input(void) const {
    return (Data_Storage::p_Tsunami_Input_C*) &p_Tsunami_Input;
}

Data_Storage::p_Tsunami_Input_C* Data_Storage::get_p_Tsunami_Input(void) const {
    return (Data_Storage::p_Tsunami_Input_C*) &p_Tsunami_Input;
}

const bool Data_Storage::getBehavior_hail(void) const {
    return behavior_hail;
}

void Data_Storage::setBehavior_hail(const bool p_behavior_hail) {
    behavior_hail = p_behavior_hail;
    NOTIFY_SET_OPERATION;
}

const bool Data_Storage::getBehavior_rain(void) const {
    return behavior_rain;
}

void Data_Storage::setBehavior_rain(const bool p_behavior_rain) {
    behavior_rain = p_behavior_rain;
    NOTIFY_SET_OPERATION;
}

const bool Data_Storage::getBehavior_snow(void) const {
    return behavior_snow;
}

void Data_Storage::setBehavior_snow(const bool p_behavior_snow) {
    behavior_snow = p_behavior_snow;
    NOTIFY_SET_OPERATION;
}
...
void Data_Storage::MainBehavior_exit(void) {
    switch (MainBehavior_subState) {
        ...
        break;
        // State polling_sensor_data
        case polling_sensor_data:
        {
            cancel(MainBehavior_timeout);
            NOTIFY_STATE_EXITED("ROOT.MainBehavior.polling_sensor_data");
        }
        break;
        ...
        break;
        // State relaying_sensor_data
        case relaying_sensor_data:
        {
            popNullTransition();
            NOTIFY_STATE_EXITED("ROOT.MainBehavior.relaying_sensor_data");
        }
        break;
        default:
            break;
            ...
            if(IS_EVENT_TYPE_OF(OMNullEventId) == 1)
                {
                    ...
                    popNullTransition();
                    NOTIFY_STATE_EXITED("ROOT.MainBehavior.accepttimeevent_2");
                    NOTIFY_STATE_ENTERED("ROOT.MainBehavior.polling_sensor_data");
                    MainBehavior_subState = polling_sensor_data;
                    rootState_active = polling_sensor_data;
                    //#[ state MainBehavior.polling_sensor_data.(Entry) 
                    ...
                    update_GUI();
                    //#]
                    MainBehavior_timeout = scheduleTimeout(1000, "ROOT.MainBehavior.polling_sensor_data");
            ...
            if(IS_EVENT_TYPE_OF(OMNullEventId) == 1)
                {
                    ...
                    popNullTransition();
                    NOTIFY_STATE_EXITED("ROOT.MainBehavior.accepttimeevent_3");
                    NOTIFY_STATE_ENTERED("ROOT.MainBehavior.relaying_sensor_data");
                    pushNullTransition();
                    MainBehavior_subState = relaying_sensor_data;
                    rootState_active = relaying_sensor_data;
                    //#[ state MainBehavior.relaying_sensor_data.(Entry) 
                    relay_storm_data();
                    relay_tsunami_data();
                    //#]
...
void Data_Storage::OMConnectRelations(void) {
    if (get_p_Storm_Input() != NULL) {
        get_p_Storm_Input()->connectData_Storage(this);
    }
    if (get_p_Tsunami_Input() != NULL) {
        get_p_Tsunami_Input()->connectData_Storage(this);
    }
}
...
void OMAnimatedData_Storage::serializeAttributes(AOMSAttributes* aomsAttributes) const {
    ...
    aomsAttributes->addAttribute("behavior_rain", x2String(myReal->behavior_rain));
    aomsAttributes->addAttribute("behavior_snow", x2String(myReal->behavior_snow));
    aomsAttributes->addAttribute("behavior_hail", x2String(myReal->behavior_hail));
}
...
void OMAnimatedData_Storage::MainBehavior_serializeStates(AOMSState* aomsState) const {
    ...
    switch (myReal->MainBehavior_subState) {
        ...
        break;
        case Data_Storage::polling_sensor_data:
        {
            polling_sensor_data_serializeStates(aomsState);
        }
        break;
        ...
        break;
        case Data_Storage::relaying_sensor_data:
        {
            relaying_sensor_data_serializeStates(aomsState);
        }
        break;
        default:
            break;
...
void OMAnimatedData_Storage::relaying_sensor_data_serializeStates(AOMSState* aomsState) const {
    aomsState->addState("ROOT.MainBehavior.relaying_sensor_data");
}

void OMAnimatedData_Storage::polling_sensor_data_serializeStates(AOMSState* aomsState) const {
    aomsState->addState("ROOT.MainBehavior.polling_sensor_data");
}
