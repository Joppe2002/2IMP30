...
bool_pred_direction_ProxyFlowPropertyInterface* News_Outlets::p_News_Outlets_1_C::getItsBool_pred_direction_ProxyFlowPropertyInterface(void) {
    return this;
}

float_pred_probability_ProxyFlowPropertyInterface* News_Outlets::p_News_Outlets_1_C::getItsFloat_pred_probability_ProxyFlowPropertyInterface(void) {
    return this;
}

float_pred_severity_ProxyFlowPropertyInterface* News_Outlets::p_News_Outlets_1_C::getItsFloat_pred_severity_ProxyFlowPropertyInterface(void) {
    return this;
}

float_pred_speed_ProxyFlowPropertyInterface* News_Outlets::p_News_Outlets_1_C::getItsFloat_pred_speed_ProxyFlowPropertyInterface(void) {
    return this;
}

float_storm_probability_ProxyFlowPropertyInterface* News_Outlets::p_News_Outlets_1_C::getItsFloat_storm_probability_ProxyFlowPropertyInterface(void) {
    return this;
}

void News_Outlets::p_News_Outlets_1_C::setPred_direction(bool p_pred_direction) {
...
void News_Outlets::p_News_Outlets_1_C::setPred_probability(float p_pred_probability) {
...
void News_Outlets::p_News_Outlets_1_C::setPred_severity(float p_pred_severity) {
...
void News_Outlets::p_News_Outlets_1_C::setPred_speed(float p_pred_speed) {
...
void News_Outlets::p_News_Outlets_1_C::setStorm_probability(float p_storm_probability) {
...
void News_Outlets::p_News_Outlets_1_C::setItsBool_pred_direction_ProxyFlowPropertyInterface(bool_pred_direction_ProxyFlowPropertyInterface* const p_bool_pred_direction_ProxyFlowPropertyInterface) {
    itsBool_pred_direction_ProxyFlowPropertyInterface = p_bool_pred_direction_ProxyFlowPropertyInterface;
}

void News_Outlets::p_News_Outlets_1_C::setItsFloat_pred_probability_ProxyFlowPropertyInterface(float_pred_probability_ProxyFlowPropertyInterface* const p_float_pred_probability_ProxyFlowPropertyInterface) {
    itsFloat_pred_probability_ProxyFlowPropertyInterface = p_float_pred_probability_ProxyFlowPropertyInterface;
}

void News_Outlets::p_News_Outlets_1_C::setItsFloat_pred_severity_ProxyFlowPropertyInterface(float_pred_severity_ProxyFlowPropertyInterface* const p_float_pred_severity_ProxyFlowPropertyInterface) {
    itsFloat_pred_severity_ProxyFlowPropertyInterface = p_float_pred_severity_ProxyFlowPropertyInterface;
}

void News_Outlets::p_News_Outlets_1_C::setItsFloat_pred_speed_ProxyFlowPropertyInterface(float_pred_speed_ProxyFlowPropertyInterface* const p_float_pred_speed_ProxyFlowPropertyInterface) {
    itsFloat_pred_speed_ProxyFlowPropertyInterface = p_float_pred_speed_ProxyFlowPropertyInterface;
}

void News_Outlets::p_News_Outlets_1_C::setItsFloat_storm_probability_ProxyFlowPropertyInterface(float_storm_probability_ProxyFlowPropertyInterface* const p_float_storm_probability_ProxyFlowPropertyInterface) {
    itsFloat_storm_probability_ProxyFlowPropertyInterface = p_float_storm_probability_ProxyFlowPropertyInterface;
}

void News_Outlets::p_News_Outlets_1_C::cleanUpRelations(void) {
    if(itsBool_pred_direction_ProxyFlowPropertyInterface != NULL)
        {
...
News_Outlets::p_News_Outlets_1_C* News_Outlets::getP_News_Outlets_1(void) const {
    return (News_Outlets::p_News_Outlets_1_C*) &p_News_Outlets_1;
}

News_Outlets::p_News_Outlets_1_C* News_Outlets::get_p_News_Outlets_1(void) const {
    return (News_Outlets::p_News_Outlets_1_C*) &p_News_Outlets_1;
}
...
void News_Outlets::OMConnectRelations(void) {
    ...
    if (get_p_News_Outlets_1() != NULL) {
        get_p_News_Outlets_1()->connectNews_Outlets(this);
    }
}
