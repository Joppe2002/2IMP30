...
Government_Networks::p_Government_Networks_1_C::p_Government_Networks_1_C(void) : bool_pred_direction_ProxyFlowPropertyInterface(), float_pred_severity_ProxyFlowPropertyInterface(), float_pred_probability_ProxyFlowPropertyInterface(), float_pred_speed_ProxyFlowPropertyInterface(), float_storm_probability_ProxyFlowPropertyInterface(), _p_(0), itsBool_pred_direction_ProxyFlowPropertyInterface(NULL), itsFloat_pred_probability_ProxyFlowPropertyInterface(NULL), itsFloat_pred_severity_ProxyFlowPropertyInterface(NULL), itsFloat_pred_speed_ProxyFlowPropertyInterface(NULL), itsFloat_storm_probability_ProxyFlowPropertyInterface(NULL) {
}

Government_Networks::p_Government_Networks_1_C::~p_Government_Networks_1_C(void) {
    cleanUpRelations();
}

void Government_Networks::p_Government_Networks_1_C::connectGovernment_Networks(Government_Networks* part) {
...
bool_pred_direction_ProxyFlowPropertyInterface* Government_Networks::p_Government_Networks_1_C::getItsBool_pred_direction_ProxyFlowPropertyInterface(void) {
    return this;
}

float_pred_probability_ProxyFlowPropertyInterface* Government_Networks::p_Government_Networks_1_C::getItsFloat_pred_probability_ProxyFlowPropertyInterface(void) {
    return this;
}

float_pred_severity_ProxyFlowPropertyInterface* Government_Networks::p_Government_Networks_1_C::getItsFloat_pred_severity_ProxyFlowPropertyInterface(void) {
    return this;
}

float_pred_speed_ProxyFlowPropertyInterface* Government_Networks::p_Government_Networks_1_C::getItsFloat_pred_speed_ProxyFlowPropertyInterface(void) {
    return this;
}

float_storm_probability_ProxyFlowPropertyInterface* Government_Networks::p_Government_Networks_1_C::getItsFloat_storm_probability_ProxyFlowPropertyInterface(void) {
    return this;
}

void Government_Networks::p_Government_Networks_1_C::setPred_direction(bool p_pred_direction) {
...
void Government_Networks::p_Government_Networks_1_C::setPred_probability(float p_pred_probability) {
...
void Government_Networks::p_Government_Networks_1_C::setPred_severity(float p_pred_severity) {
...
void Government_Networks::p_Government_Networks_1_C::setPred_speed(float p_pred_speed) {
...
void Government_Networks::p_Government_Networks_1_C::setStorm_probability(float p_storm_probability) {
...
void Government_Networks::p_Government_Networks_1_C::setItsBool_pred_direction_ProxyFlowPropertyInterface(bool_pred_direction_ProxyFlowPropertyInterface* const p_bool_pred_direction_ProxyFlowPropertyInterface) {
    itsBool_pred_direction_ProxyFlowPropertyInterface = p_bool_pred_direction_ProxyFlowPropertyInterface;
}

void Government_Networks::p_Government_Networks_1_C::setItsFloat_pred_probability_ProxyFlowPropertyInterface(float_pred_probability_ProxyFlowPropertyInterface* const p_float_pred_probability_ProxyFlowPropertyInterface) {
    itsFloat_pred_probability_ProxyFlowPropertyInterface = p_float_pred_probability_ProxyFlowPropertyInterface;
}

void Government_Networks::p_Government_Networks_1_C::setItsFloat_pred_severity_ProxyFlowPropertyInterface(float_pred_severity_ProxyFlowPropertyInterface* const p_float_pred_severity_ProxyFlowPropertyInterface) {
    itsFloat_pred_severity_ProxyFlowPropertyInterface = p_float_pred_severity_ProxyFlowPropertyInterface;
}

void Government_Networks::p_Government_Networks_1_C::setItsFloat_pred_speed_ProxyFlowPropertyInterface(float_pred_speed_ProxyFlowPropertyInterface* const p_float_pred_speed_ProxyFlowPropertyInterface) {
    itsFloat_pred_speed_ProxyFlowPropertyInterface = p_float_pred_speed_ProxyFlowPropertyInterface;
}

void Government_Networks::p_Government_Networks_1_C::setItsFloat_storm_probability_ProxyFlowPropertyInterface(float_storm_probability_ProxyFlowPropertyInterface* const p_float_storm_probability_ProxyFlowPropertyInterface) {
    itsFloat_storm_probability_ProxyFlowPropertyInterface = p_float_storm_probability_ProxyFlowPropertyInterface;
}

void Government_Networks::p_Government_Networks_1_C::cleanUpRelations(void) {
    if(itsBool_pred_direction_ProxyFlowPropertyInterface != NULL)
        {
...
Government_Networks::p_Government_Networks_1_C* Government_Networks::getP_Government_Networks_1(void) const {
    return (Government_Networks::p_Government_Networks_1_C*) &p_Government_Networks_1;
}

Government_Networks::p_Government_Networks_1_C* Government_Networks::get_p_Government_Networks_1(void) const {
    return (Government_Networks::p_Government_Networks_1_C*) &p_Government_Networks_1;
}
...
void Government_Networks::OMConnectRelations(void) {
    ...
    if (get_p_Government_Networks_1() != NULL) {
        get_p_Government_Networks_1()->connectGovernment_Networks(this);
    }
}
