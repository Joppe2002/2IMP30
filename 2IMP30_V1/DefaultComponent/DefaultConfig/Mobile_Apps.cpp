...
//## class Mobile_Apps
//#[ ignore
Mobile_Apps::p_Mobile_Apps_C::p_Mobile_Apps_C(void) : int_warning_type_ProxyFlowPropertyInterface(), _p_(0), itsInt_warning_type_ProxyFlowPropertyInterface(NULL) {
}

Mobile_Apps::p_Mobile_Apps_C::~p_Mobile_Apps_C(void) {
    cleanUpRelations();
}

void Mobile_Apps::p_Mobile_Apps_C::connectMobile_Apps(Mobile_Apps* part) {
    setItsInt_warning_type_ProxyFlowPropertyInterface(part);
    
}

int_warning_type_ProxyFlowPropertyInterface* Mobile_Apps::p_Mobile_Apps_C::getItsInt_warning_type_ProxyFlowPropertyInterface(void) {
    return this;
}

void Mobile_Apps::p_Mobile_Apps_C::setWarning_type(int p_warning_type) {
...
void Mobile_Apps::p_Mobile_Apps_C::setItsInt_warning_type_ProxyFlowPropertyInterface(int_warning_type_ProxyFlowPropertyInterface* const p_int_warning_type_ProxyFlowPropertyInterface) {
    itsInt_warning_type_ProxyFlowPropertyInterface = p_int_warning_type_ProxyFlowPropertyInterface;
}

void Mobile_Apps::p_Mobile_Apps_C::cleanUpRelations(void) {
    if(itsInt_warning_type_ProxyFlowPropertyInterface != NULL)
        {
...
Mobile_Apps::p_Mobile_Apps_C* Mobile_Apps::getP_Mobile_Apps(void) const {
    return (Mobile_Apps::p_Mobile_Apps_C*) &p_Mobile_Apps;
}

Mobile_Apps::p_Mobile_Apps_C* Mobile_Apps::get_p_Mobile_Apps(void) const {
    return (Mobile_Apps::p_Mobile_Apps_C*) &p_Mobile_Apps;
}
...
void Mobile_Apps::OMConnectRelations(void) {
    if (get_p_Mobile_Apps() != NULL) {
        get_p_Mobile_Apps()->connectMobile_Apps(this);
    }
}
