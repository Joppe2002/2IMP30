...
//#[ ignore
Tsunami_Prediction::p_Tsunami_Prediction_C::p_Tsunami_Prediction_C(void) : float_pred_probability_ts_ProxyFlowPropertyInterface(), _p_(0), itsFloat_pred_probability_ts_ProxyFlowPropertyInterface(NULL) {
}
...
float_pred_probability_ts_ProxyFlowPropertyInterface* Tsunami_Prediction::p_Tsunami_Prediction_C::getItsFloat_pred_probability_ts_ProxyFlowPropertyInterface(void) {
    return this;
}

float_pred_probability_ts_ProxyFlowPropertyInterface* Tsunami_Prediction::p_Tsunami_Prediction_C::getOutBound(void) {
    return this;
}

void Tsunami_Prediction::p_Tsunami_Prediction_C::setPred_probability_ts(float p_pred_probability_ts) {
...
void Tsunami_Prediction::p_Tsunami_Prediction_C::setItsFloat_pred_probability_ts_ProxyFlowPropertyInterface(float_pred_probability_ts_ProxyFlowPropertyInterface* const p_float_pred_probability_ts_ProxyFlowPropertyInterface) {
...
Tsunami_Prediction::Tsunami_Prediction(IOxfActive* const theActiveContext) : OMReactive(), itsActionable_Information_Generator(NULL), itsData_Storage(NULL) {
...
void Tsunami_Prediction::relay_output_data_ts(void) {
    ...
    itsActionable_Information_Generator->get_tsunami_relay_data(warned);
    }
    //#]
}

//#[ ignore
void Tsunami_Prediction::setPred_probability_ts(float p_pred_probability_ts) {
    if (pred_probability_ts != p_pred_probability_ts)  {
        pred_probability_ts = p_pred_probability_ts;
        FLOW_DATA_SEND(pred_probability_ts, p_Tsunami_Prediction, setPred_probability_ts, x2String);
    }
}
//#]
...
const bool Tsunami_Prediction::getSMS_info(void) const {
    return SMS_info;
}

void Tsunami_Prediction::setSMS_info(const bool p_SMS_info) {
    SMS_info = p_SMS_info;
    NOTIFY_SET_OPERATION;
}

const bool Tsunami_Prediction::getApp_info(void) const {
    return app_info;
}

void Tsunami_Prediction::setApp_info(const bool p_app_info) {
    app_info = p_app_info;
    NOTIFY_SET_OPERATION;
}

const bool Tsunami_Prediction::getEmergencyResponders_info(void) const {
    return emergencyResponders_info;
}

void Tsunami_Prediction::setEmergencyResponders_info(const bool p_emergencyResponders_info) {
    emergencyResponders_info = p_emergencyResponders_info;
    NOTIFY_SET_OPERATION;
}

const bool Tsunami_Prediction::getGovernment_info(void) const {
    return government_info;
}

void Tsunami_Prediction::setGovernment_info(const bool p_government_info) {
...
const bool Tsunami_Prediction::getNews_info(void) const {
    return news_info;
}

void Tsunami_Prediction::setNews_info(const bool p_news_info) {
    news_info = p_news_info;
    NOTIFY_SET_OPERATION;
}

const float Tsunami_Prediction::getPred_probability_ts(void) const {
...
const Actionable_Information_Generator* Tsunami_Prediction::getItsActionable_Information_Generator(void) const {
    return itsActionable_Information_Generator;
}

void Tsunami_Prediction::setItsActionable_Information_Generator(Actionable_Information_Generator* const p_Actionable_Information_Generator) {
    if(p_Actionable_Information_Generator != NULL)
        {
            p_Actionable_Information_Generator->_setItsTsunami_Prediction(this);
        }
    ...
    if(itsActionable_Information_Generator != NULL)
        {
            ...
            const Tsunami_Prediction* p_Tsunami_Prediction = itsActionable_Information_Generator->getItsTsunami_Prediction();
            if(p_Tsunami_Prediction != NULL)
                {
                    itsActionable_Information_Generator->__setItsTsunami_Prediction(NULL);
                }
...
void Tsunami_Prediction::__setItsActionable_Information_Generator(Actionable_Information_Generator* const p_Actionable_Information_Generator) {
...
void Tsunami_Prediction::_setItsActionable_Information_Generator(Actionable_Information_Generator* const p_Actionable_Information_Generator) {
    if(itsActionable_Information_Generator != NULL)
        {
            itsActionable_Information_Generator->__setItsTsunami_Prediction(NULL);
        }
...
void Tsunami_Prediction::_clearItsActionable_Information_Generator(void) {
    NOTIFY_RELATION_CLEARED("itsActionable_Information_Generator");
    itsActionable_Information_Generator = NULL;
}
...
void Tsunami_Prediction::normal_operation_entDef(void) {
...
void Tsunami_Prediction::normal_operation_exit(void) {
    switch (state_1_subState) {
        // State idle
        case idle:
        {
            cancel(state_1_timeout);
            NOTIFY_STATE_EXITED("ROOT.normal_operation.state_1.idle");
        }
        break;
        // State prediction
        case prediction:
        {
            popNullTransition();
            NOTIFY_STATE_EXITED("ROOT.normal_operation.state_1.prediction");
        }
        break;
        case accepttimeevent_5:
        {
            popNullTransition();
            NOTIFY_STATE_EXITED("ROOT.normal_operation.state_1.accepttimeevent_5");
        }
        break;
        default:
            break;
    ...
    state_1_subState = OMNonState;
    NOTIFY_STATE_EXITED("ROOT.normal_operation.state_1");
    state_2_exit();
    
    NOTIFY_STATE_EXITED("ROOT.normal_operation");
}

IOxfReactive::TakeEventStatus Tsunami_Prediction::normal_operation_processEvent(void) {
...
IOxfReactive::TakeEventStatus Tsunami_Prediction::normal_operation_handleEvent(void) {
    IOxfReactive::TakeEventStatus res = eventNotConsumed;
...
void Tsunami_Prediction::state_2_entDef(void) {
    NOTIFY_STATE_ENTERED("ROOT.normal_operation.state_2");
    NOTIFY_TRANSITION_STARTED("4");
    NOTIFY_STATE_ENTERED("ROOT.normal_operation.state_2.waiting");
...
void Tsunami_Prediction::state_2_exit(void) {
    switch (state_2_subState) {
        ...
        case waiting:
        {
            NOTIFY_STATE_EXITED("ROOT.normal_operation.state_2.waiting");
        }
        break;
        // State medium_risk
        case medium_risk:
        {
            popNullTransition();
            NOTIFY_STATE_EXITED("ROOT.normal_operation.state_2.medium_risk");
        }
        break;
        // State high_risk
        case high_risk:
        {
            popNullTransition();
            NOTIFY_STATE_EXITED("ROOT.normal_operation.state_2.high_risk");
        }
        break;
        // State low_risk
        case low_risk:
        {
            popNullTransition();
            NOTIFY_STATE_EXITED("ROOT.normal_operation.state_2.low_risk");
        }
        break;
        default:
            break;
    ...
    NOTIFY_STATE_EXITED("ROOT.normal_operation.state_2");
}
    ...
    switch (state_2_active) {
        ...
        case waiting:
        {
            if(IS_EVENT_TYPE_OF(evPredictionReadyTs_Architecture_id) == 1)
                {
                    //## transition 6 
                    if(pred_probability_ts<0.6)
                        {
                            NOTIFY_TRANSITION_STARTED("5");
                            NOTIFY_TRANSITION_STARTED("6");
                            NOTIFY_STATE_EXITED("ROOT.normal_operation.state_2.waiting");
                            NOTIFY_STATE_ENTERED("ROOT.normal_operation.state_2.low_risk");
                            pushNullTransition();
                            state_2_subState = low_risk;
                            state_2_active = low_risk;
                            //#[ state normal_operation.state_2.low_risk.(Entry) 
                            relay_output_data_ts();
                            if (itsActionable_Information_Generator) {
                                itsActionable_Information_Generator->GEN(evLowRiskTs());
                            }
                            warned=false;
                            ...
                            SMS_info = false;
                            app_info = false;
                            emergencyResponders_info = false;
                            //#]
                        ...
                        {
                            //## transition 7 
                            if(pred_probability_ts>=0.9)
                                {
                                    NOTIFY_TRANSITION_STARTED("5");
                                    NOTIFY_TRANSITION_STARTED("7");
                                    NOTIFY_STATE_EXITED("ROOT.normal_operation.state_2.waiting");
                                    NOTIFY_STATE_ENTERED("ROOT.normal_operation.state_2.high_risk");
                                    pushNullTransition();
                                    state_2_subState = high_risk;
                                    state_2_active = high_risk;
                                    //#[ state normal_operation.state_2.high_risk.(Entry) 
                                    relay_output_data_ts();
                                    itsActionable_Information_Generator->GEN(evHighTsunami());
                                    warned=true;
                            ...
                            else
                                {
                                    ...
                                    NOTIFY_STATE_EXITED("ROOT.normal_operation.state_2.waiting");
                                    NOTIFY_STATE_ENTERED("ROOT.normal_operation.state_2.medium_risk");
                                    pushNullTransition();
                                    state_2_subState = medium_risk;
                                    state_2_active = medium_risk;
                                    //#[ state normal_operation.state_2.medium_risk.(Entry) 
                                    relay_output_data_ts();
                                    itsActionable_Information_Generator->GEN(evMediumTsunami());
                                    warned=true;
...
void Tsunami_Prediction::state_1_entDef(void) {
    NOTIFY_STATE_ENTERED("ROOT.normal_operation.state_1");
    NOTIFY_TRANSITION_STARTED("11");
    NOTIFY_STATE_ENTERED("ROOT.normal_operation.state_1.idle");
    state_1_subState = idle;
    state_1_active = idle;
    state_1_timeout = scheduleTimeout(4000, "ROOT.normal_operation.state_1.idle");
                    ...
                    if(getCurrentEvent() == state_1_timeout)
                        {
                            ...
                            cancel(state_1_timeout);
                            NOTIFY_STATE_EXITED("ROOT.normal_operation.state_1.idle");
                            NOTIFY_STATE_ENTERED("ROOT.normal_operation.state_1.accepttimeevent_5");
                            pushNullTransition();
            ...
            if(IS_EVENT_TYPE_OF(OMNullEventId) == 1)
                {
                    ...
                    popNullTransition();
                    NOTIFY_STATE_EXITED("ROOT.normal_operation.state_1.accepttimeevent_5");
                    NOTIFY_STATE_ENTERED("ROOT.normal_operation.state_1.prediction");
                    pushNullTransition();
                    state_1_subState = prediction;
                    state_1_active = prediction;
                    //#[ state normal_operation.state_1.prediction.(Entry) 
                    pred_probability_ts = (100-vibrations_distance)*vibrations_intensity*vibrations_intensity*0.000005;
                    if (pred_probability_ts>1) pred_probability_ts=1;
...
void OMAnimatedTsunami_Prediction::serializeAttributes(AOMSAttributes* aomsAttributes) const {
    ...
    aomsAttributes->addAttribute("emergencyResponders_info", x2String(myReal->emergencyResponders_info));
}
...
void OMAnimatedTsunami_Prediction::rootState_serializeStates(AOMSState* aomsState) const {
    ...
    switch (myReal->rootState_subState) {
        case Tsunami_Prediction::normal_operation:
        {
...
void OMAnimatedTsunami_Prediction::normal_operation_serializeStates(AOMSState* aomsState) const {
...
void OMAnimatedTsunami_Prediction::state_2_serializeStates(AOMSState* aomsState) const {
    aomsState->addState("ROOT.normal_operation.state_2");
...
void OMAnimatedTsunami_Prediction::prediction_serializeStates(AOMSState* aomsState) const {
    aomsState->addState("ROOT.normal_operation.state_1.prediction");
}

void OMAnimatedTsunami_Prediction::idle_serializeStates(AOMSState* aomsState) const {
    aomsState->addState("ROOT.normal_operation.state_1.idle");
}

void OMAnimatedTsunami_Prediction::accepttimeevent_5_serializeStates(AOMSState* aomsState) const {
    aomsState->addState("ROOT.normal_operation.state_1.accepttimeevent_5");
}
