...
void SystemContext_OMConnectRelations(void) {
    ...
    }
    {
        ...
        itsSMSWTD.get_p_SMSWTD()->setItsInt_warning_type_ProxyFlowPropertyInterface(itsGovernment_Networks.get_p_Government_Networks()->getItsInt_warning_type_ProxyFlowPropertyInterface());
