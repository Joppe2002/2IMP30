...
void SystemContext_OMConnectRelations(void) {
    ...
    }
    {
        ...
        itsTsunami_Sensors.get_p_Tsunami_Sensors()->setItsInt_raw_vibrations_distance_ProxyFlowPropertyInterface(itsSMSWTD.get_p_SMSWTD_3()->getItsInt_raw_vibrations_distance_ProxyFlowPropertyInterface());
        
        itsTsunami_Sensors.get_p_Tsunami_Sensors()->setItsInt_raw_vibrations_intensity_ProxyFlowPropertyInterface(itsSMSWTD.get_p_SMSWTD_3()->getItsInt_raw_vibrations_intensity_ProxyFlowPropertyInterface());
